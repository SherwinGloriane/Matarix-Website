/**
 * Load Categories for Landing Page
 * Dynamically loads and displays categories from database on index.html
 */

// Immediate execution test
console.log('[Categories] load_landing_categories.js file loaded and executing');
...
async function loadLandingCategories() {
    console.log('[Categories] loadLandingCategories function called');
    try {
...
function initLandingCategories() {
    console.log('[Categories] initLandingCategories called, readyState:', document.readyState);
