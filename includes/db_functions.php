...
class DatabaseFunctions {
    ...
    public function insertUser($userData) {
        try {
            ...
            $stmt = $this->pdo->prepare("
                INSERT INTO users (First_Name, Middle_Name, Last_Name, Phone_Number, email, address, password, role)
                VALUES (:first_name, :middle_name, :last_name, :phone_number, :email, :address, :password, :role)
            ");
    ...
    public function getUserById($userId) {
        try {
            $stmt = $this->pdo->prepare("SELECT User_ID, First_Name, Middle_Name, Last_Name, Phone_Number, email, address, role, created_at FROM users WHERE User_ID = :user_id LIMIT 1");
